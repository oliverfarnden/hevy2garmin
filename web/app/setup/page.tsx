...
const rows = await sql`     SELECT platform, status, connected_at
...
>
{connected ? "Connected" : "Not connected"} </span> </span>
);
}
...
return ( <main className="mx-auto max-w-3xl px-4 py-8 md:px-6"> <header className="mb-6"> <h1 className="text-2xl font-bold text-text">Setup</h1>
